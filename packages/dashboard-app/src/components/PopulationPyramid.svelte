<script>
  /**
   * Created by Rich Harris (https://github.com/Rich-Harris)
   * Taken from: https://svelte.dev/repl/8686ac654dff448eafbe7cb396b8a058?version=3.32.3
   */
	import * as Pancake from '@sveltejs/pancake';
	import { spring } from 'svelte/motion';
	import { onMount } from 'svelte';
	import data from './population.stubs';
